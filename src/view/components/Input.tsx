...
export const Input = forwardRef<HTMLInputElement, InputProps>(({ name, id,  placeholder, ...props }, ref) => {
  ...
  return (
    <div className="relative">
      <input
        ...
        ref={ref}        
        id={inputId}
        className="bg-white rounded-lg w-full border border-gray-500 px-3 h-[52px] text-gray-800 pt-4 peer placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none"
        placeholder=" "
      />
      <label
        htmlFor={inputId}
